        ...
        <div
            ...
            <div class="postingan">
                            ...
                            <div x-show="isOpen"
                                ...
                                <div class="bg-white p-8 rounded-lg lg:w-1/2 w-2/3"
                                    ...
                                    <div class="flex gap-4">
                                        <a href="" class="bg-red-500 hover:bg-red-700 text-white font-light py-2 px-4 rounded">Report this post</a>
                ...
                <div class="w-full my-3">
                    <p>Lorem, Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, fuga! ipsum dolor sit
                        amet consectetur adipisicing elit. Placeat earum est exercitationem quaerat obcaecati, aliquam expedita
                        dolores vero iusto esse illum eos adipisci repudiandae voluptatibus libero minima neque numquam
                        accusantium.</p>
                </div>
                <img src="images/post.png" onclick=""
                    class="rounded-xl aspect-square lg:w-1/2 transition"
                    alt="post">
                <p class="my-3 text-sm">30 januari 2023</p>
                    ...
                    <div x-show="showComments" class="mt-4">
                        <ul>
                          <li class="flex gap-2 mb-2">
                              <img src="images/faiz.jpg" alt="profile" class="w-8 h-8 rounded-full border-primary border-2">
                              <p class="my-auto">
                                @MabidM
                                <span class="font-sans font-normal">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt nobis iusto a debitis facere ratione neque aliquam. Nam sequi vitae tenetur culpa optio, nostrum hic porro non consequuntur magni obcaecati voluptatibus at, repudiandae animi ab aut provident impedit natus nemo odit ex nesciunt? Perspiciatis molestiae laudantium quos veniam? Odit, quibusdam.</span>
                              </p>
                          </li>
                          <li class="flex gap-2 mb-2">
                              <img src="images/faiz.jpg" alt="profile" class="w-8 h-8 rounded-full border-primary border-2">
                              <p class="my-auto">
                                @Yuwan
                                <span class="font-sans font-normal">Info Loker</span>
                              </p>
                          </li>
                          <li class="flex gap-2 mb-2">
                              <img src="images/faiz.jpg" alt="profile" class="w-8 h-8 rounded-full border-primary border-2">
                            <form action="" class="flex w-full gap-2">
                                <input type="text" name="" id="" class="w-full border-primary border-2 rounded-lg p-2" placeholder="Write your coment">
            ...
            <div class="postingan my-3">
                <div class="flex justify-between">
                    <div class="flex">
                        <img src="images/faiz.jpg" alt="profile" class="w-12 h-12 rounded-full border-primary border-2">
                        <p class="my-auto ml-4 text-xl">> MabidM</p>
                    </div>
                    <div class="mt-auto mx-8 my-auto" x-data="{ isOpen: false }">
                        <button @click="isOpen = !isOpen">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="10" viewBox="0 0 40 10"
                ...
                {{-- <img src="images/post.png" onclick=""
                    class="rounded-xl aspect-square lg:w-1/2 transition"
                    alt="post"> --}}
                <p class="my-3 text-sm">30 Maret 2023</p>
                <div class="flex gap-2">
                    <div x-data="{ count: 0 }">
                        <button @click="count++" class="bg-blue-500 rounded-lg text-white px-4 py-2">
                          Like <span x-text="count"></span>
